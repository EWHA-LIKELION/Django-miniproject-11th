"""
URL configuration for ddabongproject project.
...
urlpatterns = [
    ...
    path('', ddabong.views.home, name='home'),
    path('ddabong/<int:ddabong_id>', ddabong.views.detail, name="detail"),
    path('new/', ddabong.views.new, name="new"),
    path('create/', ddabong.views.create, name="create"),
